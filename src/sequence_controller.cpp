    ...
    void mecha_state_callback(const mecha_control::msg::MechaState::SharedPtr msg) {
        ...
        if (!(msg->daiza_state == 0)) {
            ...
            case 2: // 回収
                ...
                if (!current_daiza_state_.limit_switch_states.empty() && current_daiza_state_.limit_switch_states[2]) {
        ...
        // 人形機構の処理
            ...
            case 4: // 準備
                ...
                if (!current_hina_state_.potentiometer_angles.empty() && current_hina_state_.potentiometer_angles[1] < 90.0) {
            ...
            case 1: // 展開
                ...
                if (!current_hina_state_.potentiometer_angles.empty() && current_hina_state_.potentiometer_angles[1] > -10.0) {
            ...
            case 2: // 回収
                ...
                if (!current_hina_state_.limit_switch_states.empty() && current_hina_state_.limit_switch_states[2] && current_hina_state_.limit_switch_states[3]) {
            ...
            case 3: // 設置
                ...
                if (!current_hina_state_.limit_switch_states.empty() && current_hina_state_.limit_switch_states[0]) {
                    // モータ2: ポテンショメータが-10° (調整できるようにする)になるまで動かす
